...
Вы соглашаетесь использовать бота только для легитимных, личных и некоммерческих целей.

🔒 *Конфиденциальность:*  
Ваши данные обрабатываются с максимальной заботой и не передаются третьим лицам.

⚖️ *Ответственность:*  
Вы используете бота на свой страх и риск – мы не несем ответственности за возможные последствия.

🔄 *Изменения условий:*  
Мы можем обновлять условия использования, и новые версии будут доступны в боте.
